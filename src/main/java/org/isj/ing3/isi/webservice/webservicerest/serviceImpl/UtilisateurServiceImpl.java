...
public class UtilisateurServiceImpl implements IUtilisateur {
  ...
  /*      Utilisateur createur = utilisateurRepository.findById(utilisateur.getCreateur().getCode()).orElseThrow(() -> new IsjException(ErrorInfo.RESSOURCE_NOT_FOUND));;
   ...
   /*     Utilisateur createur = utilisateurRepository.findById(utilisateur.getCreateur().getCode()).orElseThrow(() -> new IsjException(ErrorInfo.RESSOURCE_NOT_FOUND));;
    ...
    @Override
    public Utilisateur login(String login, String pw) throws IsjException {
        Utilisateur utilisateur = utilisateurRepository.getUserByLoginAndPw(login, pw).orElseThrow(() -> new IsjException("Utilisateur inconnu, nom d'utilisateur ou mot de passe incorrect", Status.BAD_REQUEST));
